    ...
    <Layout style={{ height: '100%' }}>
      <Sider width={320} style={{ background: '#fff' }}>
        ...
        <Menu
          ...
          style={{ height: 'calc(100% - 64px)', overflow: 'auto', borderRight: 0 }}
        />
      </Sider>
          ...
          {!selectedDoc ? (
            ...
            <div style={{ display: 'flex', gap: 16 }}>
              <div style={{ flex: 1 }}>
                    ...
                    <div style={{ marginTop: 20 }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
                        <div>
                          ...
                          <div style={{ color: '#888', fontSize: 12 }}>以下用户有该文档的访问权限</div>
                        </div>
                ...
                <Card title="危险操作" bordered={true}>
                  <Space direction="vertical">
                    <Button icon={<EditOutlined />} onClick={openRenameModal}>重命名文档</Button>
                    <Popconfirm
                      title="确认删除该文档？此操作无法撤销。"
                      icon={<ExclamationCircleOutlined />}
                      onConfirm={() => handleDeleteDocument(selectedDoc.id)}
          ...
          <div style={{ width: 320 }}>
            ...
            <List
              ...
              renderItem={(user) => {
                ...
                return (
                  <List.Item
                    style={{ cursor: alreadyHas ? 'not-allowed' : 'pointer', opacity: alreadyHas ? 0.5 : 1 }}
                    onClick={() => {
                      if (alreadyHas) {
                  ...
                  >
                    <List.Item.Meta
                      avatar={<Avatar style={{ backgroundColor: '#7265e6' }}>{user.username.charAt(0).toUpperCase()}</Avatar>}
